...
Inference is highly efficient: SGPE processes a typical sentence in approximately 10 ms on commodity CPU hardware (a 6-core machine running WSL2), remaining competitive with local frontier implementations and orders of magnitude faster than API round-trips.
